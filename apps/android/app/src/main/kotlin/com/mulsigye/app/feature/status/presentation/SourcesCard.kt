 ...
 */
fun estimateNotice(estimate: RegionEstimate): String =
    "공표 자료가 아직 없는 날이라, 우리 지역 저수지 ${estimate.reservoirCount}곳의 실제 측정값을 " +
        "모아 계산한 추정값이에요. 지난해 자료로 맞춰 본 오차는 평균 " +
