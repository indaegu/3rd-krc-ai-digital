    ...
    PolicyKind.LOCATION -> PolicyDoc(
        ...
        sections = listOf(
            ...
            PolicySection(
                "주소는 저장하지 않아요",
                listOf(
                    "주소를 검색할 때는 시군구를 확인하려고 잠깐 우리 서버를 거쳐요. 수신호는 주소 원문과 검색어를 데이터베이스에 담지 않고, 우리가 남기는 기록에도 적지 않아요.",
                    "다만 서비스를 올려 둔 클라우드(Vercel)가 접속 기록을 자동으로 남겨요. 여기에는 접속한 기기의 IP 주소와 요청한 인터넷 주소가 담기고, 주소 검색은 그 인터넷 주소 안에 검색어가 함께 들어가요. 이 기록은 정해진 보관 기간이 지나면 지워지고, 우리가 따로 내려받아 모아 두지 않아요.",
        ...
        sections = listOf(
            ...
            PolicySection(
                ...
                listOf(
                    ...
                    "인터넷이 끊겼을 때 마지막으로 본 화면을 그대로 보여드리려고, 받아 온 물 사정·예측 내용을 이 기기에만 잠시 남겨요. 누구나 볼 수 있는 공개 데이터이고 주소·검색어는 담기지 않아요.",
                ),
            ),
            PolicySection(
                "코치 설명을 만들 때",
