...
val WatchFg = Color(0xFF009398)
val WatchBg = Color(0xFFE2F5F5)
val CareFg = Color(0xFFDEA92E)
val CareBg = Color(0xFFFDF3DE)
val AlertFg = Color(0xFFE36C22)
val AlertBg = Color(0xFFFDEEE2)
val CritFg = Color(0xFFE33922)
val CritBg = Color(0xFFFDEAE7)
