...
공개 라이선스를 두지 않는다. 저작권은 저작권자에게 있으며, 별도 허락 없는 복제·배포·
2차적 저작물 작성을 허용하지 않는다.

공모전 수상작의 저작재산권 귀속은 공고문과 참가 동의서의 문구가 서로 달라 확인 중이다
(경위와 확인 절차: [docs/contest-rules.md](docs/contest-rules.md)).
